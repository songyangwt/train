...
$("tr.btbj:even").css({"background-color":"#bfd3fc","font-family": "黑体","font-size": "14px","font-weight":"lighter" }); 
 ...
 <link href="<%=path%>/css/table_back.css" rel="stylesheet" type="text/css">
  ...
  <body>
  ${daohang}
  <form action="<%=path%>/viewtrainapplylzz.action" method="post" name="fm1">
					...
					<tr height="50px" class="表格表头背景1" id="hang">
							...
							<tr class="btbj" id="hang" style="height:20px">
								...
								<td width="140px" height="25" align="center" valign="middle" nowrap><div
										align="center">
										<c:if test="${(newnumber==pxsq.initiator)&&(pxsq.status==1)}">
										<a href="<%=path%>/updatetrainapplystatus.action?number=${pxsq.number}&newnumber=${newnumber}">收回</a> 
										&nbsp;&nbsp;
										</c:if>
							...
							<td colspan="14">
								<div align="center">
								<a	href="<%=path%>/viewtrainapplylzz.action?newnumber=${newnumber}&currentPage=${previousPage}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/viewtrainapplylzz.action?newnumber=${newnumber}&currentPage=${nextPage}"
