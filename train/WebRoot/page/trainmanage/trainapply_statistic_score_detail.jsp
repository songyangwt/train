					...
					<table height="80" align="center" cellpadding="0"
						...
						<tr>
							<td
								...
								colspan="13" align="center" bordercolor="#FFFFFF"><b>${trainname}培训评分明细</b>
							</td>
						</tr>
						...
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<c:forEach items="${listscorename}" var="tp" varStatus="status">
							<tr class="btbj" id="hang" style="height:20px">
								...
								<td width="200px" height="25" align="center" valign="middle" nowrap><div
										align="center">${tp.name}</div></td>
								<td width="200px" height="25" align="center" valign="middle" nowrap><div
										align="center">${tp.score}</div></td>		
