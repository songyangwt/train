 ...
 <link href="<%=path%>/css/table_back.css" rel="stylesheet" type="text/css">
  ...
  <form action="<%=path%>/viewtrainapplyall.action" method="post" name="fm1">
					...
					<tr height="50px" class="表格表头背景1" id="hang">
							...
							<td colspan="14">
								<div align="center">
								<a	href="<%=path%>/viewtrainapplyall.action?newnumber=${newnumber}&currentPage=${previousPage}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/viewtrainapplyall.action?newnumber=${newnumber}&currentPage=${nextPage}"
