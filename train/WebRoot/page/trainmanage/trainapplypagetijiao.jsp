...
<html>
  ...
  $(document).ready(function(){ 
         ...
         $("#chu").attr('value',chu);
         $("#manager").attr('value',manager);
         $("#content").attr('value',content);
         if(people=="")
         {
             $("#trainpeople").css('display','none');
         }
         $('#people').attr('value',people);
         $('#time').attr('value',time);
         $('#location').attr('value',location);
         $('#requirement').attr('value',requirement);
         $('#programname').attr('value',programname);
         $('#tel').attr('value',tel);
         $('#issign').attr('value',issign);
         $('#isregister').attr('value',isregister);
         $('#isevaluate').attr('value',isevaluate);
	    ...
	    if(Number(num)!=0)
		 ...
		 if(isregister=="wu")
		  ...
		  if(trim(programname)=="")
		  {
		    ...
		    {
			  alert("请填写开始时间！");
			  document.getElementById("hour").focus();return;
			}
			if(trim(minute)=="")
		    {
			  alert("请填写开始时间！");
			  document.getElementById("minute").focus();return;
			}
        ...
        <table id="mytable"  border="1" align="center" cellpadding="1" cellspacing="0">
    		<tr height="50">
    			...
    			<td width="500" class="as" colspan="3">
    			   <select id="type" name="type" style="padding:0px;margin:0px;">&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <select id="issign" name="issign" style="padding:0px;margin:0px;">&nbsp;&nbsp;&nbsp;&nbsp;
    		...
    		<tr height="40">
    			...
    			<td width="150" class="as" >
    				...
    				<select id="chu" name="chu" style="width: 200px">
    		...
    		<tr id="trainpeople">	
    			...
    			<td width="500" class="as" colspan="3" >
    			<textarea style="text-align:left;width:450px;height:100px" id="people" name="people" >
    	    ...
    	    <td width="150" class="as">
    			...
    			<td id="fi" width="320" class="as" colspan="2">
    				 <div id="showwindow">
    				  <c:forEach items="${listtf}" var="af" varStatus="status">
    				     <a	href="javascript:download('${af.name}')">${af.filename}</a>
    				      <br>
    				  </c:forEach>
    				 </div>
    			</td>	
    		     <td width="180" class="as">
    			    ...
    			    <input style="width:50px" type="button" onclick="upload()" value="上 传"/>
    			    <input style="width:70px" type="button" onclick="hideshow()" value="删除重传"/>
    			</td>
    		</tr>
    		...
    		<td width="500" class="as" colspan="3">
    				...
    				<input type="hidden" id="tempnumber" name="tempnumber" value="${tempnumber}"/>
