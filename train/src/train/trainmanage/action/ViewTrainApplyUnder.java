...
public class ViewTrainApplyUnder {
	...
	*/
	...
	public String execute() throws Exception
	{
		...
		try {
			...
			hql = "from TManage as tm where substr(tm.thisunder,1,8)='"+newnumber1+"' or (substr(tm.initiator,1,8)='"+newnumber1+"' and tm.status in (0,5)) order by tm.id desc";
